...
namespace my_books_tests
{
    public class PublisherServiceTest
    {
        ...
        [Test, Order(1)]
        public void GetAllPublishers_WithNoSortBy_WithNoSearchString_WithNoPageNumber_WithNoPageSize_Test()
        {
            var result = publishersService.GetAllPublishers("", "", null, null);
            Assert.That(result.Count, Is.EqualTo(5));
            //Assert.AreEqual(result.Count, 5);
        }

        [Test, Order(2)]
        public void GetAllPublishers_WithNoSortBy_WithNoSearchString_WithNoPageNumber_WithPageNumber_Test()
        {
            var result = publishersService.GetAllPublishers("", "", null, 3);
            Assert.That(result.Count, Is.EqualTo(3));
        }

        [Test, Order(3)]
        public void GetAllPublishers_WithNoSortBy_WithSearchString_WithNoPageNumber_WithNoPageSize_Test()
        {
            var result = publishersService.GetAllPublishers("", "3", null, null);
            Assert.That(result.Count, Is.EqualTo(1));
            Assert.That(result.FirstOrDefault().Name, Is.EqualTo("Publisher 3"));
        }

        [Test, Order(4)]
        public void GetAllPublishers_WithSortBy_WithNoSearchString_WithNoPageNumber_WithNoPageSize_Test()
        {
            var result = publishersService.GetAllPublishers("name_descending", "", null, null);
            Assert.That(result.Count, Is.EqualTo(5));
        ...
        [Test, Order(5)]
        public void GetPublisherById_WithNoResponse_Test()
        {
        ...
        [Test, Order(7)]
        public void AddPublisherWithoutException()
        {
            var newPublisher = new PublisherVM()
            {
        ...
        public void DeletePublisher_Test()
        {
            ...
            Assert.AreEqual(countBeforeDelete, 7);
            publishersService.DeletePublisherById(1);
            int countAfterDelete = context.Publishers.Count(); 
            Assert.AreEqual(countAfterDelete, 6);
        }
